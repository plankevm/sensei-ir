//! Translator from Sensei IR to EVM assembly
...
use sir_data::{BasicBlockId, DataId, EthIRProgram, GudIndex, Idx, IndexVec, LocalId, index_vec};
...
impl Translator {
    ...
    fn allocate_all_locals(&mut self) {
        for local_id in LocalId::ZERO.iter_to(self.program.next_free_local_id) {
