...
fn calldata_size_and_load() {
    ...
    let mut operations =
        vec![Operation::CallDataSize(InlineOperands { ins: [], outs: [LocalId::new(0)] })];
    operations.extend(set_locals(&[(1, 0)]));
    operations.push(Operation::CallDataLoad(InlineOperands {
        ins: [LocalId::new(1)],
        outs: [LocalId::new(2)],
    }));
...
fn calldata_copy_to_memory() {
    ...
    operations.push(Operation::CallDataCopy(InlineOperands {
...
fn codecopy_to_memory() {
    let mut operations = set_locals(&[(0, 0), (1, 0), (2, 32)]);
    operations.push(Operation::CodeCopy(InlineOperands {
        ins: [LocalId::new(0), LocalId::new(1), LocalId::new(2)],
        outs: [],
    }));
    operations.extend(set_locals(&[(3, 0), (4, 32)]));
...
fn address_caller_origin() {
    let operations = vec![
        Operation::Address(InlineOperands { ins: [], outs: [LocalId::new(0)] }),
        Operation::Caller(InlineOperands { ins: [], outs: [LocalId::new(1)] }),
        Operation::Origin(InlineOperands { ins: [], outs: [LocalId::new(2)] }),
    ];
...
fn block_infos() {
    let operations = vec![
        Operation::Number(InlineOperands { ins: [], outs: [LocalId::new(0)] }),
        Operation::Difficulty(InlineOperands { ins: [], outs: [LocalId::new(1)] }),
        Operation::GasLimit(InlineOperands { ins: [], outs: [LocalId::new(2)] }),
        Operation::ChainId(InlineOperands { ins: [], outs: [LocalId::new(3)] }),
        Operation::Timestamp(InlineOperands { ins: [], outs: [LocalId::new(4)] }),
        Operation::BaseFee(InlineOperands { ins: [], outs: [LocalId::new(5)] }),
        Operation::Coinbase(InlineOperands { ins: [], outs: [LocalId::new(6)] }),
    ];
...
fn balance_self_and_other() {
    ...
    operations.push(Operation::Balance(InlineOperands {
        ins: [LocalId::new(0)],
        outs: [LocalId::new(1)],
    }));
    operations.push(Operation::SelfBalance(InlineOperands { ins: [], outs: [LocalId::new(2)] }));
...
fn test_log0() {
    ...
    operations.push(Operation::Log0(InlineOperands {
...
fn test_log1() {
    ...
    operations.push(Operation::Log1(InlineOperands {
        ins: [LocalId::new(3), LocalId::new(4), LocalId::new(2)],
        outs: [],
    }));
    operations.push(Operation::Stop(InlineOperands::default()));
...
fn test_log2() {
    ...
    operations
        .push(Operation::Log2(AllocatedIns::<4, 0> { ins_start: LocalIndex::new(2), outs: [] }));
    operations.push(Operation::Stop(InlineOperands::default()));
