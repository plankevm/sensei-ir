...
use eth_ir_data::{Operation, operation::*};
...
proptest! {
    ...
    fn test_bitwise_and_with_execution(a in any::<u64>(), b in any::<u64>()) {
        let ops = build_binary_op_test(a, b, |result, arg1, arg2| {
            Operation::And(TwoInOneOut { result, arg1, arg2 })
        });
    ...
    fn test_bitwise_or_with_execution(a in any::<u64>(), b in any::<u64>()) {
        let ops = build_binary_op_test(a, b, |result, arg1, arg2| {
            Operation::Or(TwoInOneOut { result, arg1, arg2 })
        });
    ...
    fn test_bitwise_xor_with_execution(a in any::<u64>(), b in any::<u64>()) {
        let ops = build_binary_op_test(a, b, |result, arg1, arg2| {
            Operation::Xor(TwoInOneOut { result, arg1, arg2 })
        });
    ...
    fn test_bitwise_not_with_execution(a in any::<u64>()) {
        let ops = build_unary_op_test(a, |result, arg1| {
            Operation::Not(OneInOneOut { result, arg1 })
        });
    ...
    #[test]
    fn test_shifts_with_execution(value in any::<u64>(), shift in 0u8..64) {
        // Test SHL (shift left)
        let ops_shl = build_binary_op_test(shift as u64, value, |result, arg1, arg2| {
            Operation::Shl(TwoInOneOut { result, arg1, arg2 })
        });
        ...
        let ops_shr = build_binary_op_test(shift as u64, value, |result, arg1, arg2| {
            Operation::Shr(TwoInOneOut { result, arg1, arg2 })
        });
...
proptest! {
    #[test]
    fn test_sar_arithmetic_shift(value in any::<u64>(), shift in 0u64..256u64) {
        // Test signed arithmetic right shift
        let ops = build_binary_op_test(shift, value, |result, arg1, arg2| {
            Operation::Sar(TwoInOneOut { result, arg1, arg2 })
        });
...
proptest! {
    #[test]
    fn test_byte_out_of_bounds(byte_index in 32u64..256u64, value in any::<u64>()) {
...
proptest! {
    ...
    fn test_comparison_lt_with_execution(a in any::<u64>(), b in any::<u64>()) {
        let ops = build_binary_op_test(a, b, |result, arg1, arg2| {
            Operation::Lt(TwoInOneOut { result, arg1, arg2 })
        });
    ...
    fn test_comparison_gt_with_execution(a in any::<u64>(), b in any::<u64>()) {
        let ops = build_binary_op_test(a, b, |result, arg1, arg2| {
            Operation::Gt(TwoInOneOut { result, arg1, arg2 })
        });
    ...
    fn test_comparison_eq_with_execution(a in any::<u64>(), b in any::<u64>()) {
        let ops = build_binary_op_test(a, b, |result, arg1, arg2| {
            Operation::Eq(TwoInOneOut { result, arg1, arg2 })
        });
    ...
    fn test_iszero_with_execution(value in any::<u64>()) {
        let ops = build_unary_op_test(value, |result, arg1| {
            Operation::IsZero(OneInOneOut { result, arg1 })
        });
...
proptest! {
    ...
    fn test_slt_signed_comparison(a in 0u64..=i64::MAX as u64, b in 0u64..=i64::MAX as u64) {
        ...
        let ops = build_binary_op_test(a, b, |result, arg1, arg2| {
            Operation::SLt(TwoInOneOut { result, arg1, arg2 })
        });
...
proptest! {
    ...
    fn test_sgt_signed_comparison(a in 0u64..=i64::MAX as u64, b in 0u64..=i64::MAX as u64) {
        ...
        let ops = build_binary_op_test(a, b, |result, arg1, arg2| {
            Operation::SGt(TwoInOneOut { result, arg1, arg2 })
        });
