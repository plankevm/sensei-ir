...
define_binary_op_test!(
    test_add,
    |result, left, right| Operation::Add(TwoInOneOut { result, arg1: left, arg2: right }),
...
define_binary_op_test!(
    test_sub,
    |result, left, right| Operation::Sub(TwoInOneOut { result, arg1: left, arg2: right }),
...
define_binary_op_test!(
    test_mul,
    |result, left, right| Operation::Mul(TwoInOneOut { result, arg1: left, arg2: right }),
...
define_binary_op_test!(
    test_div,
    |result, dividend, divisor| Operation::Div(TwoInOneOut {
        result,
        arg1: dividend,
        arg2: divisor
    }),
...
define_binary_op_test!(
    test_mod,
    |result, dividend, modulus| Operation::Mod(TwoInOneOut {
        result,
        arg1: dividend,
        arg2: modulus
    }),
...
define_signed_op_test!(
    test_sdiv,
    |result, dividend, divisor| Operation::SDiv(TwoInOneOut {
        result,
        arg1: dividend,
        arg2: divisor
    }),
...
define_signed_op_test!(
    test_smod,
    |result, dividend, modulus| Operation::SMod(TwoInOneOut {
        result,
        arg1: dividend,
        arg2: modulus
    }),
...
define_binary_op_test!(
    test_exp,
    |result, base, exponent| Operation::Exp(TwoInOneOut { result, arg1: base, arg2: exponent }),
...
fn addmod() {
    ...
    for &(addend1, addend2, modulus) in &TEST_CASES {
        let operations = vec![
            Operation::LocalSetSmallConst(SetSmallConst { local: LocalId::new(0), value: addend1 }),
            Operation::LocalSetSmallConst(SetSmallConst { local: LocalId::new(1), value: addend2 }),
            Operation::LocalSetSmallConst(SetSmallConst { local: LocalId::new(2), value: modulus }),
...
define_binary_op_test!(
    test_lt,
    |result, arg1, arg2| Operation::Lt(TwoInOneOut { result, arg1, arg2 }),
...
define_binary_op_test!(
    test_gt,
    |result, arg1, arg2| Operation::Gt(TwoInOneOut { result, arg1, arg2 }),
    |a, b| if a > b { U256::from(1) } else { U256::ZERO },
    "GT"
);
...
define_signed_op_test!(
    test_slt,
    |result, arg1, arg2| Operation::SLt(TwoInOneOut { result, arg1, arg2 }),
    |a, b| {
...
define_signed_op_test!(
    test_sgt,
    |result, arg1, arg2| Operation::SGt(TwoInOneOut { result, arg1, arg2 }),
    |a, b| {
        let a_signed = I256::from_raw(a);
        let b_signed = I256::from_raw(b);
        if a_signed > b_signed { U256::from(1) } else { U256::ZERO }
...
define_binary_op_test!(
    test_eq,
    |result, arg1, arg2| Operation::Eq(TwoInOneOut { result, arg1, arg2 }),
    |a, b| if a == b { U256::from(1) } else { U256::ZERO },
    "EQ"
);
...
define_unary_op_test!(
    test_iszero,
    |result, arg| Operation::IsZero(OneInOneOut { result, arg1: arg }),
...
define_binary_op_test!(
    ...
    |result, arg1, arg2| Operation::And(TwoInOneOut { result, arg1, arg2 }),
    |a, b| a & b,
    "AND"
);
...
define_binary_op_test!(
    test_or,
    &[(0xFF, 0x0F), (0xAA, 0x55), (0xFF, 0xFF), (0, 0xFF)],
    |result, arg1, arg2| Operation::Or(TwoInOneOut { result, arg1, arg2 }),
    |a, b| a | b,
    "OR"
);
...
define_binary_op_test!(
    test_xor,
    &[(0xFF, 0x0F), (0xAA, 0x55), (0xFF, 0xFF), (0, 0xFF)],
    |result, arg1, arg2| Operation::Xor(TwoInOneOut { result, arg1, arg2 }),
    |a, b| a ^ b,
    "XOR"
);
...
define_unary_op_test!(
    ...
    |result, arg| Operation::Not(OneInOneOut { result, arg1: arg }),
    |a| !a,
    "NOT"
);
...
define_binary_op_test!(
    ...
    |result, arg1, arg2| Operation::Byte(TwoInOneOut { result, arg1, arg2 }),
    |index, value| {
...
define_binary_op_test!(
    ...
    |result, arg1, arg2| Operation::Shl(TwoInOneOut { result, arg1, arg2 }),
...
define_binary_op_test!(
    ...
    |result, arg1, arg2| Operation::Shr(TwoInOneOut { result, arg1, arg2 }),
    |shift, value| value >> shift,
    "SHR"
);
...
define_binary_op_test!(
    test_sar,
    &[(1, 2), (2, 4), (8, 0xFF00), (1, 0x8000_0000_0000_0000)],
    |result, arg1, arg2| Operation::Sar(TwoInOneOut { result, arg1, arg2 }),
    |shift, value| {
...
define_binary_op_test!(
    ...
    |result, arg1, arg2| Operation::SignExtend(TwoInOneOut { result, arg1, arg2 }),
    |byte_num, value| {
...
fn gas_optimization_patterns() {
    ...
    let ops = vec![
        ...
        Operation::LocalSetSmallConst(SetSmallConst { local: LocalId::new(3), value: 30 }),
        Operation::Add(TwoInOneOut {
            result: LocalId::new(4),
            arg1: LocalId::new(2),
            arg2: LocalId::new(3),
